...
EXERCISE_CATALOG_IMPORT_BATCH_V1: list[ExerciseCatalogEntry] = [
    # Exercise Catalog Import Batch v1: tiny manually curated home-gym additions.
    ExerciseCatalogEntry(
        None,
        "Bodyweight Step-Up",
        "strength",
...
CURATED_EXERCISE_CATALOG.extend(EXERCISE_CATALOG_IMPORT_BATCH_V1)
