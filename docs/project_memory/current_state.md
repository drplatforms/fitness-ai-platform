...
Implemented service shell behavior:

- create job
- read job
- deterministic list/latest job selection
...
- in-memory repository/protocol boundary for tests
...
<!-- END DAILY_COACH_ASYNC_SERVICE_SHELL_NO_WORKER_V1 -->
