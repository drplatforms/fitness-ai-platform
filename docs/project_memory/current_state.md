...
- approved preview bridge remains behind disabled-by-default feature flag
...
- preview remains clearly secondary
- Developer Mode diagnostics remain gated and sanitized
- QA hardening tests cover disabled/enabled behavior and eligibility gates
- QA hardening tests prove no provider call from Today preview path
- QA hardening tests prove no async job creation from Today preview path
